...
LOG_DIR="$ROOT/logs"
PID_FILE="$LOG_DIR/opinion_scores_refresh_loop.pid"
LOG_FILE="$LOG_DIR/opinion_scores_refresh_loop.log"
LOOP_SCRIPT="$ROOT/deploy/opinion_scores_refresh_loop.sh"
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"

MANAGED_LOOP_SERVICE_ID="opinion_scores_refresh"
MANAGED_LOOP_LABEL="opinion scores refresh"
